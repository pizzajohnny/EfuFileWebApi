...
namespace EfuWebApi
{
    public class Startup
    {
        ...
        {
            services.AddSingleton<IEfuExtractorService, EfuExtractorService>();
            services.AddSingleton<IEfuItemSearchService, EfuItemSearchService>();
